...
int main(int argc, char** argv) {
    ...
    app.add_option("-a, --step_j", step_j, "The steps for the number of elements per threads (default is 1)")->check(CLI::PositiveNumber);
    app.add_option("-c, --step_k", step_k, "The steps for the number of operations per threads (default is 1)")->check(CLI::PositiveNumber);
